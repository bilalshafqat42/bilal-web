...
function WhatsAppButton() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WhatsAppButton.useEffect": ()=>{
            ...
            const onScroll = {
                "WhatsAppButton.useEffect.onScroll": ()=>{
            ...
            return ({
                "WhatsAppButton.useEffect": ()=>window.removeEventListener("scroll", onScroll)
            })["WhatsAppButton.useEffect"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WhatsAppButton.useEffect": ()=>{
            ...
            document.addEventListener("keydown", onKeyDown);
            return ({
                "WhatsAppButton.useEffect": ()=>document.removeEventListener("keydown", onKeyDown)
            })["WhatsAppButton.useEffect"];
        }
    }["WhatsAppButton.useEffect"], [
        open
...
_s(WhatsAppButton, "1hTRabFWYt1wkLGyyNoI46LkX8s=");
_c = WhatsAppButton;
var _c;
