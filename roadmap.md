...
2. Hero — **replaced 2026-08-06**, see item 20 below for the current live version (Anthropic-inspired split heading/CTA layout with a scroll-expanding photo panel). The scrolling skills ticker from the original Hero is not present in this version.
