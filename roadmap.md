...
- **Portfolio section**: a grid/wall of client company logos, not project screenshot cards. Detailed case studies with real metrics belong on a separate Portfolio/Case Studies page, not the homepage.
  - **Status: structurally done, content pending.** Homepage now shows a logo-wall section that links to `/portfolio`, which holds the full detailed write-ups. The logo tiles are still text placeholders — real client logos haven't been supplied yet.
...
4. Logo wall — grid of client company tiles, currently text placeholders (e.g. "[Client Logo — Off-Plan Developer]"), links through to `/portfolio` for the full case studies. This replaces the old on-page detailed case-study cards and satisfies the portfolio hard rule.
...
8. Engagement Models — 4 packages: Project-Based, Monthly Retainer, Ongoing Partner / Dedicated Support, Consulting & Audit. **Open decision below** — the "Audit" name needs Bilal's confirmation.
...
## Open decisions — need Bilal's answer

1. **"Consulting & Audit" package name**: this Engagement Models package reuses the word "audit," which was explicitly rejected for the CTA wording. Is that acceptable in this different context (a service package name, not a call to action), or should it be renamed?
2. **Logo wall vs. industries tag row**: should there be a separate "Industries worked in" tag row (Real Estate, SaaS, Startups, etc.) alongside the logo wall, or is the logo wall enough on its own?

Reference sites (adapt style, do not copy content):
- https://www.brionycullin.com/ (low-friction consultation CTA)
- https://www.punith.com/ (process steps)
- https://muradmurad.com/ (industries worked in)
...
- A real photo or short video of Bilal near the hero/process section (strongest personal trust signal for a solo freelancer)
