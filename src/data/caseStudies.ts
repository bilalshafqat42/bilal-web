...
const hadleyHeights: Project = {
  ...
  cardImage: "/portfolio/leos/hadley-heights/social-media/hadley-social-1.avif",
  cardBlurb:
    ...
    items: [
      {
        ...
        caption: "Slide 1 — open-plan living",
      },
      {
        file: "hadley-social-2",
        ...
        caption: "Slide 2 — the development",
      },
      {
        file: "hadley-social-3",
...
export const clients: Client[] = [
  {
    ...
    logo: "/portfolio/leos/logo/leos-logo.svg",
